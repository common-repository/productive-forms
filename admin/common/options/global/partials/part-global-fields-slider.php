...
?>
    <p>
        <h2><?php echo esc_html__( 'Global Slider Settings', 'productive-forms' ) ?></h2>
        <div><?php echo esc_html__( 'These setting are relevant to all sliders that are generated by our plugins and themes.', 'productive-forms' ) ?></div>
    </p>
<?php
}
...
function productive_global_add_section_slider_fields($productive_global_section_slider_options) {
    ...
    add_settings_field(
        ...
        __( 'Slides Transition style', 'productive-forms' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Play slides automatically?', 'productive-forms' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Play slides in Loop?', 'productive-forms' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Pause on MouseOver?', 'productive-forms' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Enable Lazy Loading?', 'productive-forms' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Delays between slides transition', 'productive-forms' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Transition Direction', 'productive-forms' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Slides Transition Controls', 'productive-forms' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Slider Controls Primary Colour', 'productive-forms' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Slider Controls Secondary Colour', 'productive-forms' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Slider Bottom Pagination Controls Shape', 'productive-forms' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Slider Side Navigation Controls Shape', 'productive-forms' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Slider Nav Controls Padding', 'productive-forms' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Widescreen', 'productive-forms' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Desktop', 'productive-forms' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Tablet (landscape)', 'productive-forms' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Tablet (portrait)', 'productive-forms' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Mobile (landscape)', 'productive-forms' ), // Field label
    ...
    add_settings_field(
        ...
        __( 'Mobile (portrait)', 'productive-forms' ), // Field label
...
function productive_global_callback_slider_transition_style( $args ) {
    ...
    ?>
        ...
        <p>
            <?php echo esc_html__( 'The style of slide transition', 'productive-forms' ); ?>
        </p>
    <?php
}
...
function productive_global_callback_slider_autoplay_enable() {
    ...
    <p>
        ...
        <label for="productive_global_section_slider_options[is_on_productive_global_slider_autoplay_enable]"><?php echo esc_html__( 'Automatically play slides.', 'productive-forms' ); ?></label>
    </p>
   <?php
}
...
function productive_global_callback_slider_play_loop_enable() {
    ...
    <p>
        ...
        <label for="productive_global_section_slider_options[is_on_productive_global_slider_play_loop_enable]"><?php echo esc_html__( 'Play slides in infinite loop', 'productive-forms' ); ?></label>
    </p>
   <?php
}
...
function productive_global_callback_slider_pause_on_mouse_over_enable() {
    ...
    <p>
        ...
        <label for="productive_global_section_slider_options[is_on_productive_global_slider_pause_on_mouse_over_enable]"><?php echo esc_html__( 'Pause slide autoplay when user hovers on slide', 'productive-forms' ); ?></label>
    </p>
   <?php
}
...
function productive_global_callback_slider_lazy_loading_enable() {
    ...
    <p>
        ...
        <label for="productive_global_section_slider_options[is_on_productive_global_slider_lazy_loading_enable]"><?php echo esc_html__( 'Enable lazy loading', 'productive-forms' ); ?></label>
    </p>
   <?php
}
...
function productive_global_callback_slider_transition_delay( $args ) {
    ...
    ?>
        ...
        <p>
            <?php echo esc_html__( 'The delay between slide transitions.', 'productive-forms' ); ?>
        </p>
    <?php
}
...
function productive_global_callback_slider_transition_direction( $args ) {
    ...
    ?>
        ...
        <p>
            <?php echo esc_html__( 'Transitions direction - only horizontal supported.', 'productive-forms' ); ?>
        </p>
    <?php
}
...
function productive_global_callback_slider_user_controls( $args ) {
    ...
    ?>
        ...
        <p>
            <?php echo esc_html__( 'Which slides transition control(s) are users allowed?', 'productive-forms' ); ?>
        </p>
    <?php
}
...
function productive_global_callback_slider_buttons_color_primary( $args ) {
    ...
    <p>
        <?php echo esc_html__( 'Effective on both side navigation and bottom pagination buttons.', 'productive-forms' ); ?>
    </p>
   <?php
}
...
function productive_global_callback_slider_pagination_control_shape( $args ) {
    ...
    ?>
        ...
        <p>
            <?php echo esc_html__( 'Pagination controls buttons shape (bottom dots)s.', 'productive-forms' ); ?>
        </p>
    <?php
}
...
function productive_global_callback_slider_nav_control_shape( $args ) {
    ...
    ?>
        ...
        <p>
            <?php echo esc_html__( 'Slider navigation control buttons shape (left and right side buttons).', 'productive-forms' ); ?>
        </p>
    <?php
}
...
function productive_global_callback_slider_slides_per_view_heading( $args ) {
    ?>
    <h3><?php echo esc_html__( 'Slides Per View Settings', 'productive-forms' ) ?></h3>
   <?php
}
...
function productive_global_callback_slider_slides_per_view_widescreen( $args ) {
    ...
    ?>
        ...
        <p>
            <?php echo esc_html__( 'Slides Per View on Widescreen', 'productive-forms' ); ?>
        </p>
    <?php
}
...
function productive_global_callback_slider_slides_per_view_desktop( $args ) {
    ...
    ?>
        ...
        <p>
            <?php echo esc_html__( 'Slides Per View on Desktop', 'productive-forms' ); ?>
        </p>
    <?php
}
...
function productive_global_callback_slider_slides_per_view_tablet_landscape( $args ) {
    ...
    ?>
        ...
        <p>
            <?php echo esc_html__( 'Slides Per View on Tablet (Landscape)', 'productive-forms' ); ?>
        </p>
    <?php
}
...
function productive_global_callback_slider_slides_per_view_tablet_portrait( $args ) {
    ...
    ?>
        ...
        <p>
            <?php echo esc_html__( 'Slides Per View on Tablet (Portrait)', 'productive-forms' ); ?>
        </p>
    <?php
}
...
function productive_global_callback_slider_slides_per_view_mobile_landscape( $args ) {
    ...
    ?>
        ...
        <p>
            <?php echo esc_html__( 'Slides Per View on Mobile (Landscape)', 'productive-forms' ); ?>
        </p>
    <?php
}
...
function productive_global_callback_slider_slides_per_view_mobile_portrait( $args ) {
    ...
    ?>
        ...
        <p>
            <?php echo esc_html__( 'Slides Per View on Mobile (Portrait)', 'productive-forms' ); ?>
        </p>
    <?php
}
